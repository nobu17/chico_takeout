...
var foodItemInputs = []foodItemTest{
	...
	{name: "error:irregular name(length 16)",
		args:             foodItemTestArgs{name: tests.MakeRandomStr(16), priority: 3, maxOrder: 4, price: 140, description: "ttt", kindId: "abc", enabled: false, scheduleIds: []string{"1", "2"}, maxOrderPerDay: 30, imageUrl: "http://google.com"},
		want:             foodItemTestArgs{},
		hasValidationErr: true,
	},
