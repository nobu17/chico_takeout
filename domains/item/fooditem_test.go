...
var foodItemInputs = []foodItemTest{
	...
	{name: "error:irregular price(0)",
		args:             foodItemTestArgs{name: "test2", priority: 1, maxOrder: 20, price: 0, description: "ttt", kindId: "abc", enabled: false, scheduleIds: []string{"1", "2"}, maxOrderPerDay: 30, imageUrl: "http://google.com", allowDates: []string{}},
		want:             foodItemTestArgs{},
		hasValidationErr: true,
	},
