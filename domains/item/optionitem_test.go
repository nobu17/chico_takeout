...
var optionTestInputs = []optionItemTestInput{
	...
	{name: "normal case:name edge case(50char)",
		args:             optionItemTestArgs{name: "あいうえおかきくけこたちつてとあいうえおあいうえおあいうえおかきくけこたちつてとあいうえおあいうえお", priority: 1, price: 100, description: "test", enabled: true},
		want:             optionItemTestArgs{name: "あいうえおかきくけこたちつてとあいうえおあいうえおあいうえおかきくけこたちつてとあいうえおあいうえお", priority: 1, price: 100, description: "test", enabled: true},
		hasValidationErr: false,
	},
	...
	{name: "error case:name over limit(51)",
		args:             optionItemTestArgs{name: "あいうえおかきくけこたちつてとあいうえおあいうえおあいうえおかきくけこたちつてとあいうえおあいうえおA", priority: 1, price: 100, description: "test", enabled: true},
		want:             optionItemTestArgs{},
		hasValidationErr: true,
	},
	...
	{name: "edge:price is 0",
		args:             optionItemTestArgs{name: "allowZero", priority: 1, price: 0, description: "test", enabled: true},
		want:             optionItemTestArgs{name: "allowZero", priority: 1, price: 0, description: "test", enabled: true},
		hasValidationErr: false,
	},
