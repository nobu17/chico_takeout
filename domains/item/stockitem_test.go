...
var stockItemInputs = []stockItemTest{
	...
	{name: "normal case2(price zero)",
		args:             stockItemTestArgs{name: maxName, priority: 3, maxOrder: 30, price: 0, description: "ttt", kindId: "abc", enabled: false, imageUrl: ""},
		want:             stockItemTestArgs{name: maxName, priority: 3, maxOrder: 30, price: 0, description: "ttt", kindId: "abc", enabled: false, imageUrl: ""},
		hasValidationErr: false,
	},
