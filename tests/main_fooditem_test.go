...
func TestFoodItemHandler_GETALL(t *testing.T) {
	...
	wants := []map[string]interface{}{
		{"priority": 1, "name": "food1", "description": "item1", "maxOrder": 4, "price": 100, "enabled": true, "kind": kinds[0], "maxOrderPerDay": 10},
		{"priority": 2, "name": "food2", "description": "item2", "maxOrder": 5, "price": 200, "enabled": true, "kind": kinds[1], "maxOrderPerDay": 18},
	}
...
func TestFoodItemHandler_POST_CREATE(t *testing.T) {
	...
	wants := []map[string]interface{}{
		{"priority": 3, "name": "create_food1", "description": "desc1", "maxOrder": 1, "price": 1000, "enabled": false, "kind": kinds[1], "maxOrderPerDay": 11, "scheduleIds": []string{scheduleIds[2]}},
		{"priority": 5, "name": "create_food2", "description": "desc2", "maxOrder": 2, "price": 2000, "enabled": true, "kind": kinds[0], "maxOrderPerDay": 14, "scheduleIds": []string{scheduleIds[0], scheduleIds[1]}},
	}
	bodies := []map[string]interface{}{
		{"priority": 3, "name": "create_food1", "description": "desc1", "maxOrder": 1, "price": 1000, "enabled": false, "kindId": kindIds[1], "maxOrderPerDay": 11, "scheduleIds": []string{scheduleIds[2]}},
		{"priority": 5, "name": "create_food2", "description": "desc2", "maxOrder": 2, "price": 2000, "enabled": true, "kindId": kindIds[0], "maxOrderPerDay": 14, "scheduleIds": []string{scheduleIds[0], scheduleIds[1]}},
	}
...
func GetFoodItemErrorData(kindIds, scheduleIds []string) []foodItemErrorData {
	var foodItemErrorInputs = []foodItemErrorData{
		{name: "lack priority", args: map[string]interface{}{
			...
			"maxOrder": 1, "price": 100, "enabled": true, "kindId": kindIds[0], "maxOrderPerDay": 5, "scheduleIds": []string{scheduleIds[0]},
		}, want: 2},
		...
		{name: "error name(over limit(16))", args: map[string]interface{}{
			...
			"maxOrder": 1, "price": 100, "enabled": true, "kindId": kindIds[0], "maxOrderPerDay": 1, "scheduleIds": []string{scheduleIds[0]},
		}, want: 2},
		...
		{name: "lack maxOrder", args: map[string]interface{}{
			"priority": 1, "name": "stock1", "description": "item1",
			"price": 100, "enabled": true, "kindId": kindIds[0], "maxOrderPerDay": 1, "scheduleIds": []string{scheduleIds[0]},
		}, want: 2},
		{name: "error maxOrder(0)", args: map[string]interface{}{
			"priority": 1, "name": "stock1", "description": "desc",
			"maxOrder": 0, "price": 100, "enabled": true, "kindId": kindIds[0], "maxOrderPerDay": 1, "scheduleIds": []string{scheduleIds[0]},
		}, want: 2},
		{name: "error maxOrder(31)", args: map[string]interface{}{
			"priority": 1, "name": "stock1", "description": "desc",
			"maxOrder": 31, "price": 100, "enabled": true, "kindId": kindIds[0], "maxOrderPerDay": 1, "scheduleIds": []string{scheduleIds[0]},
		}, want: 2},
		{name: "lack price", args: map[string]interface{}{
			"priority": 1, "name": "stock1", "description": "item1",
			"maxOrder": 1, "enabled": true, "kindId": kindIds[0], "maxOrderPerDay": 1, "scheduleIds": []string{scheduleIds[0]},
		}, want: 2},
		{name: "error price(0)", args: map[string]interface{}{
			"priority": 1, "name": "stock1", "description": "desc",
			"maxOrder": 1, "price": 0, "enabled": true, "kindId": kindIds[0], "maxOrderPerDay": 1, "scheduleIds": []string{scheduleIds[0]},
		}, want: 2},
		{name: "error price(20001)", args: map[string]interface{}{
			"priority": 1, "name": "stock1", "description": "desc",
			"maxOrder": 1, "price": 20001, "enabled": true, "kindId": kindIds[0], "maxOrderPerDay": 1, "scheduleIds": []string{scheduleIds[0]},
		}, want: 2},
		{name: "lack enabled", args: map[string]interface{}{
			"priority": 1, "name": "stock1", "description": "item1",
			"maxOrder": 1, "price": 100, "kindId": kindIds[0], "maxOrderPerDay": 1, "scheduleIds": []string{scheduleIds[0]},
		}, want: 2},
		{name: "lack kindId", args: map[string]interface{}{
			"priority": 1, "name": "stock1", "description": "item1",
			"maxOrder": 1, "price": 100, "enabled": true, "maxOrderPerDay": 1, "scheduleIds": []string{scheduleIds[0]},
		}, want: 2},
		{name: "error kindId(empty)", args: map[string]interface{}{
			"priority": 1, "name": "stock1", "description": "desc",
			"maxOrder": 1, "price": 100, "enabled": true, "kindId": "", "maxOrderPerDay": 1, "scheduleIds": []string{scheduleIds[0]},
		}, want: 2},
		{name: "not exist kindId", args: map[string]interface{}{
			"priority": 1, "name": "stock1", "description": "item1",
			"maxOrder": 1, "price": 100, "enabled": true, "kindId": "abc", "maxOrderPerDay": 1, "scheduleIds": []string{scheduleIds[0]},
		}, want: 2},
		{name: "lack maxOrderPerDay", args: map[string]interface{}{
			"priority": 1, "name": "stock1", "description": "item1", "maxOrder": 1,
			"price": 100, "enabled": true, "kindId": kindIds[0], "scheduleIds": []string{scheduleIds[0]},
		}, want: 2},
		{name: "error maxOrderPerDay(101)", args: map[string]interface{}{
			"priority": 1, "name": "stock1", "description": "item1", "maxOrder": 1,
			"price": 100, "enabled": true, "kindId": kindIds[0], "maxOrderPerDay": 101, "scheduleIds": []string{scheduleIds[0]},
		}, want: 2},
		...
		{name: "lack scheduleIds", args: map[string]interface{}{
			"priority": 1, "name": "stock1", "description": "item1", "maxOrder": 1,
			"price": 100, "enabled": true, "kindId": kindIds[0], "maxOrderPerDay": 101},
			want: 2},
		{name: "error scheduleIds(empty)", args: map[string]interface{}{
			"priority": 1, "name": "stock1", "description": "item1", "maxOrder": 1,
			"price": 100, "enabled": true, "kindId": kindIds[0], "maxOrderPerDay": 99, "scheduleIds": []string{},
		}, want: 2},
		{name: "error not exists scheduleIds", args: map[string]interface{}{
			"priority": 1, "name": "stock1", "description": "item1", "maxOrder": 2,
			"price": 100, "enabled": true, "kindId": kindIds[0], "maxOrderPerDay": 10, "scheduleIds": []string{"1234"},
		}, want: 2},
		{name: "error not exists scheduleIds and exist id", args: map[string]interface{}{
			"priority": 1, "name": "stock1", "description": "item1", "maxOrder": 2,
			"price": 100, "enabled": true, "kindId": kindIds[0], "maxOrderPerDay": 10, "scheduleIds": []string{scheduleIds[1], "1234"},
		}, want: 2},
		{name: "error maxOrder > maxOrderPerDay", args: map[string]interface{}{
			"priority": 1, "name": "stock1", "description": "item1", "maxOrder": 2,
			"price": 100, "enabled": true, "kindId": kindIds[0], "maxOrderPerDay": 1, "scheduleIds": []string{scheduleIds[1]},
		}, want: 2},
	}
